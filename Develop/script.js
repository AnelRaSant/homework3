...
var userInput = parseInt(prompt("How many characters would you like your password to contain?", "length of at least 8 characters and no more than 128 characters"
    ));
//ALERT 1
alert("Click on OK to see the character types to include in your password");
// confirm boxes
var lowercase = confirm('Click OK to use LOWERCASE characters');
var uppercase = confirm('Click OK to use UPPERCASE characters');
var numbers = confirm('Click OK to use NUMBERS');
var special = confirm('Click OK to use SPECIAL CHARACTERS');
